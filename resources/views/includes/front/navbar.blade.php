<header class="mb-5">
    ...
    <nav class="main-navbar">
        <div class="container d-flex justify-content-center align-items-center">
            <ul>
                <li class="menu-item {{ Route::currentRouteName() === 'front.form.pengaduan' ? 'active' : '' }}">
                    <a href="{{route('front.form.pengaduan')}}" class='menu-link'>
                        <div><i class="bi bi-card-checklist fs-5 me-2"></i> Form Pengaduan</div>
                    </a>
                </li>  

                <li class="menu-item {{ Route::currentRouteName() === 'front.index' ? 'active' : '' }}">
                    <a href="{{route('front.index')}}" class='menu-link'>
                        <div><i class="bi bi-newspaper fs-5 me-2"></i> Semua Pengaduan</div>
                    </a>
                </li>                         

                <li class="menu-item {{ Route::currentRouteName() === 'front.statistik.pengaduan' ? 'active' : '' }}">
                    <a href="{{route('front.statistik.pengaduan')}}" class='menu-link'>
