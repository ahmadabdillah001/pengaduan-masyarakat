...
@section('content')
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            <div class="auth-logo">
                <a href="{{url('/')}}">
                    <img src="{{ asset('images/adu.png') }}" class="logo-pengaduan" alt="Logo">
                </a>
            </div>
            <!-- <h1 class="auth-title">Log in.</h1> -->
            <p class="auth-subtitle mb-5 m-auth">Log in with your data that you entered during registration.</p>
